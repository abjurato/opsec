...
1. Если эта опция включена, геопозиция будет отправляться без дополнительных уведомлений по запросу людей из списка 2 через приложение _Найти друзей _(_Find my Friend_)
...
2. опция _Всегда_ должна быть лишь абсолютного минимума программ которым ты точно доверяешь и знаешь что у них нет спрятанной функции передачи геопозиции
